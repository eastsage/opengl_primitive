...
bool Context::Init() {
    ...
    glClearColor(0.7f, 1.1f, 0.2f, 0.0f);
...
static const char * primitive[]{"box", "cylender", "sphere", "donut"};
...
void Context::Render() {
    ...
    if (ImGui::Begin("ui window")) {
        ...
        ImGui::Separator();
        ImGui::LabelText("vertices", "vertices");
        ImGui::LabelText("triangles", "triangles");
        ImGui::
    }
    ImGui::End();
